...
import imag2 from '../../assets/imagc.jpg';
            ...
            <section className='grid grid-cols-1 md:grid-cols-2 place-items-center min-h-[800px]'>
                ...
                <motion.button
                 ...
                 className='outline-btn flex justify-center items-center gap-4 group'>
                  <a href="https://wa.me/542984792639?text=Hola quiero hacer un pedido" target="_blank"><span className='text-2xl font-bold bg-blue-600 hover:bg-primary/35 px-4 py-2.5 rounded-lg'>Encargar</span></a>
                <BsWhatsapp
